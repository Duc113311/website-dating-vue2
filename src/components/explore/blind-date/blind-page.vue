...
<script>
import BhNothank from "../../../components/bh-element-ui/button/bh-nothank";
import BhJoin from "../../../components/bh-element-ui/button/bh-join";
...
<style lang="css">
.bg-image {
  background-image: url("@/assets/image-dating/bg_blind_date\ \(2\).png");
  z-index: 99;
